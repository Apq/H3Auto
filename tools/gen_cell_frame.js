// Regenerate HA_cell.pcx: a uniform 2px gold border around a cyan-keyed
// transparent interior. Matches the other HA_*.pcx assets:
// version 5, encoding 1 (RLE), 8 bits/plane, 3 planes (24-bit RGB).
const fs = require('fs');
